////////////////////////////////////////////////////////////////////////////////
//
// Filename : configuration_test.sv
// Author : Asmara Rauf
// Creation Date : 08/20/2024
//
// Description
// ===========
// This module contains configuration test, extended from uvm_test base component.
//
// ///////////////////////////////////////////////////////////////////////////////


class configuration_test extends uvm_test;
  ...
  repeat($urandom_range(1,5000)) begin
    rand_config = $urandom_range(1,4);
    case (rand_config)
      1: port1_test(); 
      3: port2_test(); 
  ...
  fork 
    begin
      repeat($urandom_range(1,4000)) begin
  	rand_config = $urandom_range(1,4);
	case (rand_config)
    	  1: port2_test(); 
    	  2: port0_test(); 
